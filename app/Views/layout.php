    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="<?= base_url('admin/home') ?>">
          <img style="width: 100%;" src="assets/images/logo/kejari.png" alt="logo" />
        </a>
      </div>
        ...
        <li class="nav-item mb-2">
          ...
          <li class="nav-item nav-item-has-children mb-2">
            ...
            <ul id="ddmenu_1" class="collapse dropdown-nav">
              <li>
                <a href="<?= base_url('admin/jenis') ?>"> Jenis Surat </a>
              </li>
              <li>
                <a href="<?= base_url('admin/disposisi') ?>"> Disposisi </a>
              </li>
              <li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="terms d-flex justify-content-center justify-content-md-end">
                <a href="#0" class="text-sm">Arsip</a>
                <a href="#0" class="text-sm ml-15">Surat</a>
              </div>
            </div>
          </div>
          <!-- end row -->
